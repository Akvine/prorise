...
INSERT INTO TASK (ID, UUID, TITLE, DESCRIPTION, START_DATE, PRIORITY_TYPE, EMPLOYER_ID, GOAL_ID, STATUS, IS_DONE, CREATED_DATE, IS_DELETED) VALUES (1, 'task_uuid_1', 'task_title_1', 'task_description_1', '2023-03-19', 'MEDIUM', 1, 1, 'IN_PROGRESS', 0, '2023-03-19', 0);
INSERT INTO TASK (ID, UUID, TITLE, DESCRIPTION, START_DATE, PRIORITY_TYPE, EMPLOYER_ID, GOAL_ID, STATUS, IS_DONE, CREATED_DATE, IS_DELETED) VALUES (2, 'task_uuid_2', 'task_title_2', 'task_description_2', '2023-03-19', 'MEDIUM', 1, 1, 'IN_PROGRESS', 0, '2023-03-19', 0);
INSERT INTO TASK (ID, UUID, TITLE, DESCRIPTION, START_DATE, PRIORITY_TYPE, EMPLOYER_ID, GOAL_ID, STATUS, IS_DONE, CREATED_DATE, IS_DELETED) VALUES (3, 'task_uuid_3', 'task_title_3', 'task_description_3', '2023-03-19', 'MEDIUM', 1, 1, 'IN_PROGRESS', 0, '2023-03-19', 0);